...
At Relanto, a service-based company, I am deployed as a client-facing developer at Cisco. From the Cisco location, I am actively involved in two major projects: the development of the Badging-Service for the Cisco U Platform and the LearningSpace project.
...
- Managed the configuration and connection with AWS X-Ray to facilitate efficient trace storage and analysis, thereby improving system visibility and diagnostic capabilities.
